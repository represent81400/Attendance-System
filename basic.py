...
imgIbra = face_recognition.load_image_file('/Users/milosmicunovic/Desktop/attendance/ibra.webp')
imgIbra = cv2.cvtColor(imgIbra, cv2.COLOR_BGR2RGB)
imgTest = face_recognition.load_image_file('/Users/milosmicunovic/Desktop/attendance/ibra2.jpeg')
